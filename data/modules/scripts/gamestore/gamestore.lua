...
GameStore.Categories = {
    -- Premium Time
    {
        ...
        rookgaard = true,
        state = GameStore.States.STATE_NONE,
        subclasses = { "Vip time", "Palladin" },
    },
    -- VIP ~ Time
    {
        icons = { "scroll.png" },
        name = "Vip time",
        parent = premiumCategoryName,
        rookgaard = true,
        state = GameStore.States.STATE_NONE,
        offers = {
            {
    ...
    -- Consumables
    {
        ...
        name = "Consumables",
        rookgaard = true,
        subclasses = { "Blessings", "Casks", "Exercise Weapons", "Kegs", "Potions", "Runes", "Tibiadrome" },
    },
    ...
    -- Consumables ~ Tibiadrome
    {
        ...
        offers = {
            ...
            },
            {
                ...
                itemtype = 36726,
                count = 1,
                description = "<i>Drinking this potion will increase offensive Charm trigger chances by 5% (except Cripple) for one hour.</i>\n\n{character}\n{storeinbox}\n{battlesign}\n{capacity}",
                type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
            },
            {
                icons = { "Stamina_Extension.png" },
            ...
            },
            {
                ...
                itemtype = 36728,
                count = 1,
                description = "<i>Drinking this potion will make kills count twice for the Bestiary for one hour.</i>\n\n{character}\n{storeinbox}\n{battlesign}\n{capacity}",
                type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
            },
            {
                icons = { "Bestiary_Betterment.png" },
